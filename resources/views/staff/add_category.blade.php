...
@section('content')
    ...
    <br>
    <form action="https://localhost/health4all/staff/add/staff_category" method="post" accept-charset="utf-8" class="form-horizontal" role="form" id="add_staff_category">
