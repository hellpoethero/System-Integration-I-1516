...
<div id="wrap">
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="http://localhost:8000/">Tích hợp hệ thống</a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">

                    <li>
                        <a href="http://localhost:8000/dashboard"></i> Trang chủ </a>
                    </li>
                    <li>
                        <a href="http://localhost:8000/staff/create"><i class="fa fa-user"></i> Nhân lực </a>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown  "><a href="" class="dropdown-toggle js-activated" data-toggle="dropdown">admin <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="/dashboard"><i class="fa fa-gear"></i> Settings</a></li>
                            <li class="divider"></li>
                            <li><a href="/dashboard"><i class="fa fa-edit"></i> Change Password</a></li>
    ...
    <div class="container">
        ...
        <link rel="stylesheet" href="http://localhost/health4all/assets/css/metallic.css">
        <script type="text/javascript" src="http://localhost/health4all/assets/js/zebra_datepicker.js"></script>
